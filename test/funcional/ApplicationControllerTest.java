...
public class ApplicationControllerTest extends AbstractTest {
	...
	public void callNewAnuncio() {
		...
		formData.put("email","carla@ccc.br");
		formData.put("face","carla@ccc.br");
		formData.put("objetivo","Procuro Banda");
		formData.put("instrumentos","piano");
		formData.put("estilo_gosta","sertanejo");
		formData.put("estilo_nao_gosta","funk");
		formData.put("codigo","1234");
